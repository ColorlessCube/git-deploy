...
from flaskz.rest import get_rest_log_msg, rest_permission_required, init_model_rest_blueprint
from flaskz.utils import create_response

from ..api import api_bp
from ..modules.project import Project

init_model_rest_blueprint(Project, api_bp, '/project', module='project', to_json_option={'cascade': 1})
